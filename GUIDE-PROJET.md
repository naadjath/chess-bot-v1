...
> ⚠️ **Piège à éviter** : ne pas confondre les données d'entraînement et les données de test. On garde ~2% des parties de côté (`validation set`), jamais vues à l'entraînement, pour mesurer l'accuracy honnêtement.
